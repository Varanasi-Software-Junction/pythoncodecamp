...
# https://github.com/Varanasi-Software-Junction/pythoncodecamp/blob/ba8654ec5f4118ca6d366c4dbc478886b4c1288e/pattern/patterns/arrow.PNG

n = 7 #n=no of rows and no of columns as well
mid = (n + 1)/2
for row in range(1, n + 1): # loop for rows
    for col in range(1, n + 1):# loop for columns
        condition = row == mid or col - row == mid - 1 or row + col == n + mid # Condition for drawing 0
